...
export const CampaignCard = React.memo(
  function CampaignCard({ campaign, theme: t, G, glowColor }: CampaignCardProps) {
  ...
  (prev, next) => {
    return (
      ...
      prev.campaign.processed === next.campaign.processed &&
      prev.campaign.total === next.campaign.total &&
      prev.campaign.shortlisted === next.campaign.shortlisted &&
      prev.campaign.avgMatch === next.campaign.avgMatch &&
      prev.campaign.title === next.campaign.title &&
      prev.campaign.department === next.campaign.department &&
      prev.campaign.location === next.campaign.location
    );
  }
);
